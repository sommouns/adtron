  ...
  <div class="app-container">
    ...
    <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['system:sb:keywords:import']"
        >导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:sb:keywords:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPermi="['system:sb:keywords:remove']"
        >清空</el-button>
      </el-col>
...
<script>
import { listSBkeyword,delAllSBkeyword, delSBkeyword } from "@/api/system/sbkeywordsbid";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/sb/bid/import",
      },
      matchType:[],
      // 查询参数
      queryParams: {
  ...
  methods: {
    ...
    getList() {
      ...
      listSBkeyword(this.queryParams).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/sb/bid/export', {
        ...this.queryParams
      }, `sbkeywordsbid_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
