<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="否词类型" align="center" prop="negativeType" :formatter="formatNegativeType"/>
...
export default {
  ...
  methods: {
    ...
    formatNegativeType(row, column, cellValue, index) {
      for (let i = 0; i < this.negativeTypeList.length; i++) {
        if (cellValue == this.negativeTypeList[i].value) {
          return this.negativeTypeList[i].label;
        }
      }
      return "";
    },
