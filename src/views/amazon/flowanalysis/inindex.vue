  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item>
        <el-tooltip
          type="primary"
          content="跳入流量不包含品牌广告数据,已推广报告暂不支持SD广告"
          placement="top"
        >
    ...
    >
      ...
      />
      <el-table-column label="跳入单量" align="center" prop="flowOrder" />
      <el-table-column
        label="跳入销售额"
        align="center"
        prop="flowSalesAmount"
      />
      <el-table-column label="跳入率" align="center" prop="flowRate">
        <template slot-scope="scope">
          <span>{{
    ...
    >
      <el-table
        ...
        show-summary
      >
        <el-table-column label="跳出asin" align="center" prop="asin">
...
<script>
import { inList, inAsin } from "@/api/amazon/flowanalysis";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      inList(this.queryParams).then((response) => {
