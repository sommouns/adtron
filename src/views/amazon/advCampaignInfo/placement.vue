...
export default {
  ...
  data() {
    return {
      ...
      strategyList:[
        {value:'legacyForSales',label:'动态出价-只降低'},
        {value:"autoForSales",label:'动态出价-提高和降低'},
    ...
    batchUpdateState(){
      ...
      if (this.dataList.length>0){
        ...
        if (strategyTo == "动态出价-下降"){
          this.priceForm.strategy="legacyForSales";
        }else if (strategyTo == "动态出价"){
          this.priceForm.strategy="autoForSales";
        }else{
        ...
        if (percentage != "-"){
          ...
          this.priceForm.placementTop = undefined;
        }
      }
      if (this.dataList.length > 2){
        ...
        if (percentageTo != "-"){
          ...
          this.priceForm.productPage = undefined;
        }
      }
    },
    submitFormState(){
