<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="父ASIN" prop="partnerAsin">
        <el-input
      ...
      <el-form-item>
        <el-tooltip
          type="primary"
          content="运营报表暂不包含品牌广告数据,已推广报告暂不支持SD广告"
          placement="top"
        >
...
<script>
import { listPartnerSalesData } from "@/api/amazon/salesData";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listPartnerSalesData(this.queryParams).then((response) => {
    ...
    getSummaries(param) {
      ...
      columns.forEach((column, index) => {
        ...
        if (index === 5 || index === 6 || index === 10 || index === 12) {
          return;
        }
        //订单量
        if (index === 7) {
